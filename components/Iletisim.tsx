...
export default function Iletisim() {
  return (
    <>
      <Drawer>
        <DrawerTrigger className="py-5 px-8 bg-orange-400 rounded-sm hover:text-white hover:bg-opacity-0 transition duration-300 border shadow-[2px_2px_5px_rgb(0_0_0/1)]  border-black/[0] shadow-black">
